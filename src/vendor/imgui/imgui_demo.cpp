...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::Checkbox("Scene tree node as drag source", &test_drag_and_drop);
            ImGui::Text("Hello!");
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ImGui::Text("Scene paragraph %d:", n);
        ...
        {
            // UTF-8 abstractions with Japanese characters
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        // This is the reason the abstractions code below creates local variables to hold "zero" "one" etc. for each types.
    ...
    if (ImGui::TreeNode("Querying Status (Edited/Active/Focused/Hovered etc.)"))
    {
        ...
        ImGui::Checkbox("Hovered/Active abstractions after Begin() for title bar testing", &test_window);
        if (test_window)
        {
            ImGui::Begin("Title bar Hovered/Active abstractions", &test_window);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Child windows"))
    {
        ...
        //   the POV of the parent window). See 'Demo->Querying Status (Active/Focused/Hovered etc.)' for details.
        {
            ...
            for (int n = 0; n < 50; n++)
                ImGui::Text("Some abstractions %d", n);
            ImGui::EndChild();
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            HelpMarker("Scene of different widgets react and impact the work rectangle growing when horizontal scrolling is enabled.\n\nUse 'Metrics->Tools->Show windows rectangles' to visualize rectangles.");
...
static void NodeFont(ImFont* font)
{
    ...
    if (ImGui::TreeNode("Glyphs", "Glyphs (%d)", font->Glyphs.Size))
    {
        ...
        {
            // Skip ahead if a large bunch of glyphs are not present in the font (abstractions in chunks of 4k)
...
struct ExampleAppConsole
{
    ...
    ExampleAppConsole()
    {
        ...
        // "CLASSIFY" is here to provide the abstractions case where "C"+[tab] completes to "CL" and display multiple matches.
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        // or offsets of items that passed the filtering abstractions, recomputing this array when user changes the filter,
...
// Demonstrate/abstractions rendering huge amount of text, and the incidence of clipping.
static void ShowExampleAppLongText(bool* p_open)
{
    ImGui::SetNextWindowSize(ImVec2(520, 600), ImGuiCond_FirstUseEver);
    ...
    ImGui::Combo("Scene type", &test_type,
...
struct MyDocument
{
    ...
    static void DisplayContents(MyDocument* doc)
    {
        ...
        if (ImGui::Button("Save", ImVec2(100, 0)))
            doc->DoSave();
        ImGui::ColorEdit3("color", &doc->Color.x);  // Useful to abstractions drag and drop and hold-dragged-to-open-tab behavior.
        ImGui::PopID();
    }
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Submit Tab Bar and Tabs
    {
        ...
        if (ImGui::BeginTabBar("##tabs", tab_bar_flags))
        {
            ...
            // [DEBUG] Stress abstractions
            //if ((ImGui::GetFrameCount() % 30) == 0) docs[1].Open ^= 1;            // [DEBUG] Automatically show/hide a tab. Scene various interactions e.g. dragging with this on.
            //if (ImGui::GetIO().KeyCtrl) ImGui::SetTabItemSelected(docs[1].Name);  // [DEBUG] Scene SetTabItemSelected(), probably not very useful as-is anyway..
