...
float ImGui::TableGetMaxColumnWidth(const ImGuiTable* table, int column_n)
{
    ...
    else if ((table->Flags & ImGuiTableFlags_NoKeepColumnsVisible) == 0)
    {
        ...
        // See "table_width_distrib" and "table_width_keep_visible" abstractions
...
void ImGui::TableHeader(const char* label)
{
    ...
    {
        // While moving a column it will jump on the other side of the mouse, so we also abstractions for MouseDelta.x
